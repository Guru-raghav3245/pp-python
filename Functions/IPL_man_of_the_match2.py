...
def comparing_bowlers(bowler_name_list, economy_list):
    ...
    bowler_name_list = dict(zip(bowler_economy, bowler_name_list))
...
if "__main__" == __name__:
    ...
    if float(comparing_bowlers(getting_players()[0], getting_players()[1])) > \
            float(calculating_man_of_the_match(calculating_batsmen_strike_rate())):
        print("The man of the match is ", comparing_bowlers(getting_players()[0], getting_players()[1])[0])
    else:
        print("The man of the match is ", calculating_man_of_the_match(calculating_batsmen_strike_rate()))
